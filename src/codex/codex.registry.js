export const repoRegistry = [
  ...
  { name: "AthenaMyst_Host", path: "../AthenaMyst_Host", env: "MKWorldWide/AthenaMyst_Host", agent: "Athena" },
  { name: "AthenaMyst_Test", path: "../AthenaMyst_Test", env: "MKWorldWide/AthenaMyst_Test", agent: "Athena" },
  ...
  { name: "CursorKitt3n", path: "../CursorKitt3n", env: "MKWorldWide/CursorKitt3n", agent: "CursorKitten" },
  ...
  { name: "GameDinDiscord", path: "../GameDinDiscord", env: "MKWorldWide/GameDinDiscord", agent: "Seraphina" },
  ...
  { name: "Genesis-Drive", path: "../Genesis-Drive", env: "MKWorldWide/Genesis-Drive", agent: "Sovereign" },
  ...
  { name: "MatrixOS-Layer0", path: "../MatrixOS-Layer0", env: "MKWorldWide/MatrixOS-Layer0", agent: "Athena" },
  { name: "MKronoSphere", path: "../MKronoSphere", env: "MKWorldWide/MKronoSphere", agent: "Athena" },
  { name: "MKZenith", path: "../MKZenith", env: "MKWorldWide/MKZenith", agent: "Athena" },
  { name: "NovaSanctum", path: "../NovaSanctum", env: "MKWorldWide/NovaSanctum", agent: "CursorKitten" },
  { name: "NovaTiny", path: "../NovaTiny", env: "MKWorldWide/NovaTiny", agent: "CursorKitten" },
  { name: "Primal-Genesis-Engine-Sovereign", path: "../Primal-Genesis-Engine-Sovereign", env: "MKWorldWide/Primal-Genesis-Engine-Sovereign", agent: "Sovereign" },
  { name: "primal-genesis-manifest", path: "../primal-genesis-manifest", env: "MKWorldWide/primal-genesis-manifest", agent: "Sovereign" },
  { name: "Project-LOWKEY", path: "../Project-LOWKEY", env: "MKWorldWide/Project-LOWKEY", agent: "Athena" },
  { name: "PuppyThoth", path: "../PuppyThoth", env: "MKWorldWide/PuppyThoth", agent: "CursorKitten" },
  { name: "RezzonanceTouch", path: "../RezzonanceTouch", env: "MKWorldWide/RezzonanceTouch", agent: "Aletheia" },
  { name: "S.O.S.", path: "../S.O.S.", env: "MKWorldWide/S.O.S.", agent: "Athena" },
  { name: "Scrypt", path: "../Scrypt", env: "MKWorldWide/Scrypt", agent: "Athena" },
  { name: "Shadow-Nexus", path: "../Shadow-Nexus", env: "MKWorldWide/Shadow-Nexus", agent: "Athena" },
  { name: "SKyCitadel", path: "../SKyCitadel", env: "MKWorldWide/SKyCitadel", agent: "Athena" },
  { name: "SolAscension", path: "../SolAscension", env: "MKWorldWide/SolAscension", agent: "Athena" },
  { name: "SoulScript", path: "../SoulScript", env: "MKWorldWide/SoulScript", agent: "Athena" },
  { name: "WhispurrNet", path: "../WhispurrNet", env: "MKWorldWide/WhispurrNet", agent: "CursorKitten" }
];
